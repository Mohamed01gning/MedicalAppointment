...
public class Med
{
    ...
    @NotBlank(message = "*",groups = ValidationGroup.group1.class)
    private String tel;
    @Pattern(regexp = "^(MED)$",message = "La valeur dd ce CHAMP NE PEUT ETRE que 'MED'", groups = ValidationGroup.group4.class)
    @NotBlank(message = "*",groups = ValidationGroup.group1.class)
    private String role;
    private String pwd;
    ...
    public Med(String nom, String prenom, String email, String tel, String role) {
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
        this.tel = tel;
    ...
    public Med(String matricule, String nom, String prenom, String email, String tel, String role) {
    ...
    public Med(String matricule, String nom, String prenom, String email, String tel, String role, String pwd) {
        this.matricule = matricule;
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
