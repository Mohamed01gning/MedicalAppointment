...
public class AdminDTO
{
    ...
    @NotBlank(message = "*",groups = ValidationGroup.group1.class)
    private String tel;
    @Pattern(regexp = "^(ALL|ADMIN)$",message = "cE CHAMP NE PEUT ETRE 'ALL' OU 'ADMIN'", groups = ValidationGroup.group4.class)
    @NotBlank(message = "*",groups = ValidationGroup.group1.class)
    private String role;
    private String pwd;
    ...
    public AdminDTO(String matricule, String nom, String prenom, String email, String tel, String role) {
